...
<div>
  ...
  <div className="px-6 py-4">
    <a href="" className="w-full px-32 py-2 text-center text-white bg-green-600 rounded-md dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-900 hover:bg-teal-400">
    Pilih Mobil</a>
  </div>
    </div>
